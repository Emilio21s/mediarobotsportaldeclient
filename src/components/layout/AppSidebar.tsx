...
function NavItem({
  ...
  return (
    <Link
      to={to}
      className="group mx-1.5 flex items-center gap-2.5 px-2.5 py-1.5 text-[13px] text-foreground transition-colors hover:bg-[var(--sidebar-hover)] data-[active=true]:bg-[var(--sidebar-accent)] data-[active=true]:font-medium active rounded"
