...
function NavItem({
  ...
  return (
    <Link
      to={to}
      className="group mx-1.5 flex items-center gap-2.5 px-2.5 py-1.5 text-[13px] text-foreground transition-colors hover:bg-[var(--sidebar-hover)] data-[active=true]:bg-[var(--sidebar-accent)] data-[active=true]:font-medium active active rounded-md"
  ...
  return (
    <aside className="hidden h-screen w-[260px] shrink-0 flex-col border-r border-[var(--sidebar-border)] bg-[var(--sidebar)] md:sticky md:top-0 md:flex bg-zinc-50">
      ...
      <nav className="flex-1 overflow-y-auto pb-2">
        ...
        <div className="space-y-0.5 px-0 pl-0">
